...
todos.get("/", async (c) => {
  try {
    ...
    console.error("Error in GET /api/v1/todos:", error);
    throw error;
  }
});
...
todos.post("/", async (c) => {
  try {
    ...
    console.error("Error in POST /api/v1/todos:", error);
    throw error;
  }
});
...
todos.put("/:id", async (c) => {
  try {
    ...
    console.error("Error in PUT /api/v1/todos/:id:", error);
    throw error;
  }
});
...
todos.delete("/:id", async (c) => {
  try {
    ...
    console.error("Error in DELETE /api/v1/todos/:id:", error);
    throw error;
  }
});
